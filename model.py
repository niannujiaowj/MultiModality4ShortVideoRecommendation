...
def prepare_data(interaction_file: Path = "data/interaction_information.csv",
                 ...
                 output_merged_file_path: Path = "data/"):
    '''
...
class MM4SCRDataset(Dataset):
    def __init__(self, data: pd.DataFrame, tokenizer: BertTokenizer, descriptio_max_token_len: int = 50,
                 comment_max_token_len : int = 20, subtitle_max_token_len: int = 1000):
        self.data = data
...
if __name__ == '__main__':
    ...
    category_cols = ['Clothing ID', 'Division Name', 'Department Name', 'Class Name']
